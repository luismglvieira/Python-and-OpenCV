...
#player_x = input("How many players?: ")
...
player_2 = random.randrange(1,4,1)

if player_2 == 1:
    print("Player 2 entered rock.")
elif player_2 == 2:
    print("Player 2 entered paper.")
elif player_2 == 3:
    print("Player 2 entered scissors.")
else:
    print("Player 2 didn't enter a valid answer.")
print()
print('Player 1: ' + str(player_1.get_string()))
#print('Player 2: ' + str(player_2.get_string()))
print()
result = rps_res(player_1.get_res(),player_2)
